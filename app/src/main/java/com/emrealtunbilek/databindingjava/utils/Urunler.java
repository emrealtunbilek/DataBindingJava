package com.emrealtunbilek.databindingjava.utils;
...
public class Urunler {
    ...
    public Urun[] tumUrunlerDizi = {KIRMIZI_KUPA, MAVI_KUPA, KIRMIZI_LAMBA, SARI_LAMBA, BEYAZ_SAPKA, TURUNCU_SAPKA, BEYAZ_KUPA, BEYAZ_SAPKA};
